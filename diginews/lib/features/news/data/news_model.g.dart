...
NewsModel _newsModelDeserialize(
  ...
  object.sourceName = reader.readStringOrNull(offsets[2]);
...
extension NewsModelQueryFilter
  ...
  QueryBuilder<NewsModel, NewsModel, QAfterFilterCondition> sourceNameIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
  ...
  QueryBuilder<NewsModel, NewsModel, QAfterFilterCondition> sourceNameEqualTo(
    String? value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NewsModel, NewsModel, QAfterFilterCondition> sourceNameLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<NewsModel, NewsModel, QAfterFilterCondition> sourceNameBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<NewsModel, NewsModel, QAfterFilterCondition> sourceNameEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NewsModel, NewsModel, QAfterFilterCondition> sourceNameContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<NewsModel, NewsModel, QAfterFilterCondition> sourceNameMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
...
extension NewsModelQuerySortBy on QueryBuilder<NewsModel, NewsModel, QSortBy> {
  ...
  QueryBuilder<NewsModel, NewsModel, QAfterSortBy> sortBySourceName() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'sourceName', Sort.asc);
    });
  }

  QueryBuilder<NewsModel, NewsModel, QAfterSortBy> sortBySourceNameDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension NewsModelQuerySortThenBy
  ...
  QueryBuilder<NewsModel, NewsModel, QAfterSortBy> thenBySourceName() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'sourceName', Sort.asc);
    });
  }

  QueryBuilder<NewsModel, NewsModel, QAfterSortBy> thenBySourceNameDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'sourceName', Sort.desc);
    });
  }
...
extension NewsModelQueryWhereDistinct
  ...
  QueryBuilder<NewsModel, NewsModel, QDistinct> distinctBySourceName(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension NewsModelQueryProperty
  ...
  QueryBuilder<NewsModel, String?, QQueryOperations> sourceNameProperty() {
    return QueryBuilder.apply(this, (query) {
